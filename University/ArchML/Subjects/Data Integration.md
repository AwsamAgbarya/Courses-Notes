# Data Warehousing, ETL, and SQL/OLAP
...
1. **Early search space pruning:** If values are obvious or known, we do not need to search the entire space for it and we can eliminate complexity with pruning them.
